...
class VolumeKubus extends StatefulWidget {
  @override
  _VolumeKubusState createState() => _VolumeKubusState();
}

class _VolumeKubusState extends State<VolumeKubus> {
  double result;
  double formula;
    ...
    handleResult(){
      if(sisiController.text.toString().isEmpty){
        ...
        setState(() {
          ...
          result = getNumber * getNumber * getNumber;
        });
      }
    }
